...
COMMON      := -Wall -Wno-psabi -O3 -mword-relocations -fomit-frame-pointer -ffunction-sections $(ARCH) $(INCLUDE) -DARM11 -D_3DS
...
SHLISTFILES	:= $(foreach dir,$(SOURCES),$(notdir $(call recurse,f,$(dir),*.shlist)))
